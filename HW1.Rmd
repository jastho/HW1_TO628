...
```{r, indent = "    "}
barplot(tapply(nycfl$arr_delay, nycfl$carrier, mean, na.rm = TRUE), main = "Average Arrival Delays by Airline", xlab = "Airline", ylab = "Average Delay (min)", ylim = c(-10, 25), cex.names = 0.8)
```
